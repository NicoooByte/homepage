...
function setUpUnicode() {
    ...
    output.innerHTML = ":";
    img_height = Math.floor((window.innerHeight + 100) / output.clientHeight) + 1;
    img_width = Math.floor(img_height * 1.7);
    output.style.height = ""
    output.innerHTML = ":".repeat(img_width)
    widthUncidodeLine = (output.clientWidth + 1)
